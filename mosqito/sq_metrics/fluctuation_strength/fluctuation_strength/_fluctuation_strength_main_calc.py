...
from mosqito.sq_metrics.fluctuation_strength.fluctuation_strength._ear_filter_coeff import _ear_filter_coeff
from mosqito.utils.conversion import freq2bark, db2amp, amp2db, bark2freq

def _fluctuation_strength_main_calc(spec, freq_axis, fs, gzi, hWeight):
    """
    [*WARNING*] Fluctuation Strength main calculation.
